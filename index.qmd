# CASA00025 SQLitos' Cordillera Blanca Risk App (CBRA) {.unnumbered}
...
![Thresholds calibrated against 159 study basins and 5 historical GLOF sites in the Cordillera Blanca. Original Rounce et al. (2016) thresholds (30°/45°) raised to 45°/55° following Sattar et al. (2023). Tier elevation based on Sattar et al. (2021).](images/Glacier Basin Flood Index.png)

![Dynamic failure: Rounce et al. (2016), Sattar et al. (2023) — slope thresholds for rockfall (≥45°) and avalanche (≥55°) susceptibility. Self-destructive failure: Fujita et al. (2013) — SLA ≥10° as indicator of moraine structural instability](images/Flood Hazard Assessment.png)
...
![Cordillera Blanca Risk App - static image of basin selection](images/App static image.png)
...
::: {layout-ncol=2}
![Engaging IDB GLOF Stakeholders](images/IDB Peru GLOF Stakeholder Engagement Email.png)

![SQLitos Tool Walkthrough with IDB ](images/Stakeholder Engagement Call - IDB.jpeg)
:::
